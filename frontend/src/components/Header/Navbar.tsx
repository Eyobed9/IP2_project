...
const Navbar = ({ role }: Props) => {
	...
	return (
		<header className="flex items-center font-sans justify-between md:w-screen md:pr-25 md:py-1">
			{/* logo */}
			<div className="w-[100px] ml-6">
				<img src={logo} className="w-max" alt="AASTU logo" />
			</div>
			{/*navbar*/}
			<nav className="flex items-center place-items-center justify-center">
