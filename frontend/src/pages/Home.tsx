...
const Home = () => {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col">
			<main className="flex-1 flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-6 py-16 gap-10">
				<div className="flex-1 flex flex-col gap-8">
					...
					<p className="text-lg text-gray-700 mb-6">
						Your health is our top priority. We provide quality
						healthcare services with compassion, professionalism,
						and advanced technology. Book appointments, view your
						medical records, and connect with our expert doctors
						online.
					</p>
			...
			<section className="bg-blue-100 py-12">
				<div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-10">
					...
					<div className="flex flex-col items-center text-center">
						...
						<p className="text-gray-600">
							State-of-the-art equipment and comfortable
					...
					<div className="flex flex-col items-center text-center">
						...
						<p className="text-gray-600">
							We are here for you any time, any day. Your health
							matters to us.
						</p>
					</div>
				</div>
			...
			<footer className="bg-blue-700 py-6 mt-10">
