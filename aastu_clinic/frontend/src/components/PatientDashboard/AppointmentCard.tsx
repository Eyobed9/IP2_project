...
const AppointmentCard = () => {
  ...
  useEffect(() => {
    fetch(
      "http://localhost/ip2_project/aastu_clinic/backend/API/appointmentInfo.php",
      {
        method: "GET",
        credentials: "include",
      }
  ...
  const handleSubmit = async (e: React.ChangeEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost/ip2_project/aastu_clinic/backend/API/appointment.php",
        form,
      ...
      <div className="mb-50 bg-blue-50 flex flex-row w-fit h-fit justify-center gap-12 p-10 border rounded-2xl md:shadow-xl">
        {isScheduled ? (
          <div className="text-center">
            ...
            <p className="text-gray-700">
              <span className="font-semibold">Physician:</span> {data.physician}
            </p>
            <p className="text-gray-700">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                >
                  ...
                  <option value="Dr. Ethan Reynolds">Dr. Ethan Reynolds</option>
                  ...
                  <option value="Dr. Daniel Walker">Dr. Daniel Walker</option>
                </select>
              </div>
              <button
                type="submit"
