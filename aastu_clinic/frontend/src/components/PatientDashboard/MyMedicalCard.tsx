...
const MyMedicalCard = () => {
  ...
  useEffect(() => {
    fetch(
      "http://localhost/ip2_project/aastu_clinic/backend/API/sendCardInfo.php",
      {
        method: "GET",
        credentials: "include",
      }
  ...
  return (
    <div className="md:mb-40 mb-10 flex flex-col place-items-center justify-center">
      <div
        ref={cardRef}
        className="mb-2 bg-blue-50 print:bg-white flex flex-row print:w-fit print:h-fit print:justify-center gap-12 p-10 md:border md:rounded-2xl md:shadow-xl"
      >
        <div className="flex flex-col gap-6 print:lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <div className="w-30 h-30 overflow-hidden border border-gray-200 rounded-full dark:border-gray-800 mx-auto">
              <img
                src={`http://localhost/ip2_project/aastu_clinic/backend/public/${data.profilePic}`}
                alt="user"
              />
            </div>
